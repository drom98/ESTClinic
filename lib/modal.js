...
var restaurarUtilizador = function restaurarUtilizador() {
  ...
  var _loop = function _loop(i) {
    btnRestaurarUser[i].addEventListener('click', function () {
      ...
      fetch('../../backend/admin/query_editar_user.php?userid=' + btnRestaurarUser[i].name).then(function (resposta) {
...
var aprovarUtilizador = function aprovarUtilizador() {
  ...
  var _loop2 = function _loop2(i) {
    btnAprovarUser[i].addEventListener('click', function () {
      ...
      var modalTitleEl = document.querySelectorAll('.modal-card-title');
      modalEl.classList.toggle('is-active');
      fetch('../../backend/admin/query_editar_user.php?userid=' + btnAprovarUser[i].name).then(function (resposta) {
        return resposta.json();
      }).then(function (data) {
...
var eliminarPermanente = function eliminarPermanente() {
  ...
  var _loop3 = function _loop3(i) {
    btnApagarPerma[i].addEventListener('click', function () {
      ...
      var modalTitleEl = document.querySelectorAll('.modal-card-title');
      modalEl.classList.toggle('is-active');
      fetch('../../backend/admin/query_editar_user.php?userid=' + btnApagarPerma[i].name).then(function (resposta) {
        return resposta.json();
      }).then(function (data) {
...
var submeterAlteracoes = function submeterAlteracoes(id, login, nome, email, tipoUser) {
