                ...
                <div class="column is-half">
                    <div class="card">
                      <div class="card-content">
                        <h1 class="title has-text-info is-4">Iniciar sessão</h1>
                        <h2 class="subtitle is-6">Entre com a sua conta.</h2>
                        <div class="field">
                        ...
                        <div class="field">
                          <label class="label">Email:</label>
                            <div class="control has-icons-left">
                              <input type="email" class="input is-info" placeholder="Insira o seu email...">
                              <span class="icon is-small is-left">
